    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        if return_dict_in_generate:
            ...
            log_tokens = torch.zeros([1,3])
            log_tokens[0,0] = first_token_time * 1000
            log_tokens[0,1] = np.mean(last_token_time) * 1000
            log_tokens[0,2] = len(last_token_time) 
            return log_tokens
            #input_ids = torch.cat((input_ids,log_tokens),1)
            #return input_ids   ## 0805
